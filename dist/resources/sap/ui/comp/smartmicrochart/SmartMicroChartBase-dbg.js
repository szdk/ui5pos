...
sap.ui.define([
	...
	"sap/ui/core/Core"
], function(jQuery, library, MLibrary, ChartProvider, NumberFormat, DateFormat, BindingMode, DateType, Log, Control, SmartMicroChartRenderer, Core) {
	"use strict";
	...
	SmartMicroChartBase.prototype._updateAssociation = function (associationName, data) {
		...
		if (this.getMetadata().hasAssociation(associationName)) {
			oAssociation = Core.byId(this.getAssociation(associationName));
