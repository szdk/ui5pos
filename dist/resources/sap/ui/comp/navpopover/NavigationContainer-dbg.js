...
sap.ui.define([
	'sap/m/Link', 'sap/ui/core/Control', 'sap/m/VBox', 'sap/m/HBox', 'sap/m/Button', 'sap/m/Title', 'sap/ui/core/library', 'sap/m/Image', 'sap/m/Text', 'sap/ui/layout/form/SimpleForm', './Factory', './LinkData', 'sap/ui/model/json/JSONModel', './Util', 'sap/ui/layout/HorizontalLayout', 'sap/ui/layout/VerticalLayout', 'sap/ui/layout/library', 'sap/ui/comp/personalization/Util', 'sap/ui/base/ManagedObjectObserver', 'sap/m/FlexItemData', 'sap/ui/model/BindingMode', 'sap/m/library', 'sap/ui/comp/personalization/Controller', 'sap/ui/comp/personalization/SelectionWrapper', 'sap/ui/comp/personalization/ColumnWrapper', 'sap/base/Log', 'sap/ui/core/CustomData', 'sap/ui/core/Component'
], function(Link, Control, VBox, HBox, Button, Title, coreLibrary, Image, Text, SimpleForm, Factory, LinkData, JSONModel, Util, HorizontalLayout, VerticalLayout, layoutLibrary, PersonalizationUtil, ManagedObjectObserver, FlexItemData, BindingMode, mLibrary, Controller, SelectionWrapper, ColumnWrapper, Log, CustomData, Component) {
	"use strict";
	...
	NavigationContainer.prototype._getComponent = function() {
		...
		if (typeof oComponent === "string") {
			oComponent = Component.get(oComponent);
		}
		return oComponent;
	};
